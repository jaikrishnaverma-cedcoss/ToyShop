...
let saree= databases.restaurants.filter((osx, i) => {
    return (databases.restaurants[i].Material_type!=='saree')
   })
      ...
      <>
        <div className="nav2 clr3 row w100 flexAIC flexSB" style={{ marginTop: "0.5%" }}>
          ...
          <i class="fa fa-bars m1" aria-hidden="true" style={{fontSize:"23px"}}></i> 
            ...
            <button className="btn btn-trans fclBlack">BOYS</button>
            <button className="btn btn-trans fclBlack">GIRLS</button>
            <button className="btn btn-trans fclBlack">OUTDOOR</button>
            <button className="btn btn-trans fclBlack">INDOOR</button>
        ...
        <div className="w100 col btn-trans ">
          {/* <img style={{ width: "100%",marginBottom:"5%" }} src="banner2.webp" alt="" /> */}

          <img src="sBanner.jpg" width="100%" alt="" /> 
        <div className="w100 cardss">
          <div className="row flexSE">
                    <div className="col card  m1 bgWhite ccard" onClick={()=>getProduct(1)}>
                       <h2 className='m1'>#ToyShop se liya</h2>
                                ...
                                <div className="col card  m1 ccard bgWhite" onClick={()=>getProduct(2)}>
                                ...
                                <div className="col card  m1 bgWhite ccard" onClick={()=>getProduct(3)}>
                                ...
                                <div className="col card  m1 bgWhite ccard" onClick={()=>getProduct(4)}>
         ...
         <div className="w100">
          <div className="row w100 flexJCC" style={{ marginBottom: "3%" }}>
         ...
         <img src="shortBanner.jpg" width="100%" alt="" />
